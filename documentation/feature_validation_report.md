...
| FeatureGroupManager | — — | — | — | — | — | — | — | — | — | — | — | — | — | — | — | — |
  ...
  - ℹ️ **Collector/low_variance_check:** Publication Lag is constant across the current dataset. This is expected for this data snapshot and does not indicate a pipeline regression.
...
| FeatureGroupManager | — — | — | — | — | — | — | — | — | — | — | — | — | — | — | — | — |
  ...
  - ℹ️ **Merger/low_variance_check:** Publication Lag is constant across the current dataset. This is expected for this data snapshot and does not indicate a pipeline regression.

  - ✅ **Dataset Builder/null_rate:** 25.0% null (provenance coupling check below)
  - ✅ **Dataset Builder/scientific_validation:** Publication Lag within valid scientific bounds (>=0)
  - ℹ️ **Dataset Builder/low_variance_check:** Publication Lag is constant across the current dataset. This is expected for this data snapshot and does not indicate a pipeline regression.

  - ✅ **merged_feature_table.csv/null_rate:** 25.0% null (provenance coupling check below)
  - ✅ **merged_feature_table.csv/scientific_validation:** Publication Lag within valid scientific bounds (>=0)
  - ℹ️ **merged_feature_table.csv/low_variance_check:** Publication Lag is constant across the current dataset. This is expected for this data snapshot and does not indicate a pipeline regression.

  - ✅ **analysis_ready_dataset.csv/null_rate:** 25.0% null (provenance coupling check below)
  - ✅ **analysis_ready_dataset.csv/scientific_validation:** Publication Lag within valid scientific bounds (>=0)
  - ℹ️ **analysis_ready_dataset.csv/low_variance_check:** Publication Lag is constant across the current dataset. This is expected for this data snapshot and does not indicate a pipeline regression.

  - ✅ **train_dataset.csv/null_rate:** 25.9% null (provenance coupling check below)
  - ✅ **train_dataset.csv/scientific_validation:** Publication Lag within valid scientific bounds (>=0)
  - ℹ️ **train_dataset.csv/low_variance_check:** Publication Lag is constant across the current dataset. This is expected for this data snapshot and does not indicate a pipeline regression.
